...
$stmt->bind_Param("sss", $tableau[2], $tableau[4], $tableau[5]);
...
if ( $nb < 50){
  ...
  $stmt = $mysqli->prepare('INSERT INTO reservation (nom,nombre_de_personne,date,heure) VALUES (?,?,?,?)');

  $stmt->bind_Param("siss", $tableau[0], $tableau[1], $tableau[2],  $tableau[3] );

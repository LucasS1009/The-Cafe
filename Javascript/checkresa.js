document.getElementById("send").onclick = checkReservation
...
function checkReservation() {
    ...
    xhttp.open("GET", "PHP/checkReservation.php?q="+str);
    xhttp.send();
  }
...
function getresa(){
  ...
  reservation.push(document.getElementById("nom").value);
  reservation.push(document.getElementById("nombre").value);
  reservation.push(document.getElementById("date2").value);
